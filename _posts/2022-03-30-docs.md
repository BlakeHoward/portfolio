...
splash_img_caption: blakehoward/portfolio on GitHub.
---
## About
This post has details of how I made this website. You can follow the instructions below to make your own.

## Getting Started
* [Install Jekyll](https://jekyllrb.com/docs/installation/){:target="_blank"} <i class="fa fa-external-link" aria-hidden="true"></i>
* Fork/Clone/Download [this portfolio's repo](https://github.com/blakehoward/portfolio.git){:target="_blank"} <i class="fa fa-external-link" aria-hidden="true"></i>
...
`_config.yml`
```yaml
title: Blake Howard's Portfolio # Shown in header on pages with full_logo: true
...
url: "https://blakehoward.github.io/portfolio" # The base hostname & protocol for your site

author:
  name: Blake Howard
  github: blakehoward/portfolio # GitHub username, used for GitHub icon on the top right
  ...
  homepage: https://blake.how # This links to your name in post meta
...
date: 2022-03-20 # Publish date in YYYY-MM-DD format
...
## Development
Current development status is active. If resources allow, fixes will be made as soon as they are found and features will be added as soon as they are deemed fit. Feel free to contribute to this portfolio by opening a pull request on [GitHub](https://github.com/blakehoward/portfolio).

## Questions and Comments
Feel free to open a new issue on [GitHub](https://github.com/blakehoward/portfolio){:target="_blank"} <i class="fa fa-external-link" aria-hidden="true"></i> for questions and comments regarding this portfolio.